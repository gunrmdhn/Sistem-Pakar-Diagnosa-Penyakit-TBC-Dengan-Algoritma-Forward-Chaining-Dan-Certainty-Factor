...
<div class="col-md-10">
    <input onfocus="(this.type='date')" onblur="(this.type='text')" type="text" class="form-control @error('tanggal_registrasi')
        is-invalid
    @enderror" placeholder="Tanggal Registrasi" name="tanggal_registrasi"
        value="{{ old('tanggal_registrasi',$pasien->tanggal_registrasi) }}" autofocus>
...
<div class="col-md-12">
    <input type="text" class="form-control @error('nama_pasien')
        is-invalid
    @enderror" placeholder="Nama Pasien" name="nama_pasien" value="{{ old('nama_pasien',$pasien->nama_pasien) }}">
    @error('nama_pasien')
    <div class="invalid-feedback">
        {{ $message }}
    </div>
...
<div class="col-md-6">
    <input onfocus="(this.type='date')" onblur="(this.type='text')" type="text" class="form-control @error('tanggal_lahir')
        is-invalid
    @enderror" placeholder="Tanggal Lahir" name="tanggal_lahir"
...
<div class="col-md-6">
    <input type="number" min="0" class="form-control @error('usia')
        is-invalid
    @enderror" placeholder="Usia" name="usia" value="{{ old('usia',$pasien->usia) }}">
    @error('usia')
    <div class="invalid-feedback">
        {{ $message }}
    </div>
...
<div class="col-md-6">
    <input type="text" class="form-control @error('alamat')
        is-invalid
    @enderror" placeholder="Alamat" name="alamat" value="{{ old('alamat',$pasien->alamat) }}">
    @error('alamat')
    <div class="invalid-feedback">
        {{ $message }}
    </div>
...
<div class="col-md-6">
    ...
    is-invalid
    @enderror" placeholder="Nomor Telepon" name="nomor_telepon"
...
<div class="col-md-6">
    <select id="jenis_kelamin" class="form-select" name="jenis_kelamin">
        ...
        @if (old('jenis_kelamin',$pasien->jenis_kelamin)==$jenis)
...
<div class="col-md-6">
    <select id="golongan_darah" class="form-select" name="golongan_darah">
        ...
        @if (old('golongan_darah',$pasien->golongan_darah)==$golongan)
